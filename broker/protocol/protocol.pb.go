...
const (
	...
	AppendRequest_SUSPEND_KEEP AppendRequest_Suspend = 4
)
...
type ReadRequest struct {
	...
	// up.
	MinEtcdRevision int64 `protobuf:"varint,9,opt,name=min_etcd_revision,json=minEtcdRevision,proto3" json:"min_etcd_revision,omitempty"`
}
...
type AppendRequest struct {
	...
	// the request. If the broker is behind, it waits for its KeySpace to catch
	// up.
	MinEtcdRevision int64 `protobuf:"varint,10,opt,name=min_etcd_revision,json=minEtcdRevision,proto3" json:"min_etcd_revision,omitempty"`
...
type FragmentStoreHealthRequest struct {
	...
	CheckDelete bool `protobuf:"varint,2,opt,name=check_delete,json=checkDelete,proto3" json:"check_delete,omitempty"`
	...
	CheckDeletePrefix string `protobuf:"bytes,3,opt,name=check_delete_prefix,json=checkDeletePrefix,proto3" json:"check_delete_prefix,omitempty"`
}
...
var fileDescriptor_0c0999e5af553218 = []byte{
	...
	,
	...
	0xcc, 0x32, 0x45, 0x62, 0x58, 0x19, 0xab, 0x21, 0x02, 0x29, 0xd7, 0x6b, 0x22, 0xd4, 0xc7, 0x2c,
	0x13, 0xad, 0x83, 0x4c, 0x1c, 0x73, 0xe0, 0x5a, 0x0e, 0x3f, 0x69, 0xa6, 0x9a, 0xfb, 0xe1, 0xb8,
	...
	,
}
...
func (this *AppendRequest) Equal(that interface{}) bool {
	...
	if this.MinEtcdRevision != that1.MinEtcdRevision {
		return false
	}
...
func (m *ReadRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MinEtcdRevision != 0 {
		i = encodeVarintProtocol(dAtA, i, uint64(m.MinEtcdRevision))
		i--
		dAtA[i] = 0x48
	}
	if m.BeginModTime != 0 {
...
func (m *FragmentStoreHealthRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CheckDeletePrefix) > 0 {
		i -= len(m.CheckDeletePrefix)
		copy(dAtA[i:], m.CheckDeletePrefix)
		i = encodeVarintProtocol(dAtA, i, uint64(len(m.CheckDeletePrefix)))
		i--
		dAtA[i] = 0x1a
	}
	if m.CheckDelete {
...
func (m *ReadRequest) ProtoSize() (n int) {
	...
	if m.MinEtcdRevision != 0 {
		n += 1 + sovProtocol(uint64(m.MinEtcdRevision))
	}
	return n
}
...
func (m *ReadRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinEtcdRevision", wireType)
			}
			m.MinEtcdRevision = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinEtcdRevision |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *FragmentStoreHealthRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CheckDelete", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CheckDelete = bool(v != 0)
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CheckDeletePrefix", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CheckDeletePrefix = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProtocol(dAtA[iNdEx:])
