...
Example: gazctl cat examples/a-journal --offset 1234 --follow
This reads journal content from byte-offset 1234, and blocks to read new content as it is appended.`,
