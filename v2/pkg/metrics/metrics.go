...
const (
	...
	CommitsTotalKey                   = "gazette_failed_commits_total"
...
// GazetteBrokerCollectors list of collectors used by the gazette broker.
...
// GazconsumerCollectors list of collectors used by the gazette consumer.
