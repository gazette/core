...
// drives local journal handling in response to v3_allocator.State, powers
// journal resolution, and is also an implementation of protocol.BrokerServer.
type Service struct {
	jc       pb.JournalClient
	etcd     clientv3.KV
	resolver *resolver
...
// NewService constructs a new broker Service, driven by v3_allocator.State.
