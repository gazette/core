...
type BaseConfig struct {
	Consumer struct {
		Module string `long:"module" env:"MODULE" required:"t" description:"Path to consumer module to dynamically load"`
	...
	Etcd struct {
		...
		Prefix string `long:"prefix" env:"PREFIX" required:"t" description:"Etcd prefix for consumer state and coordination (eg, /gazette/consumers/myApplication)"`
